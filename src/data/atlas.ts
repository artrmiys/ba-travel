...
export const ATLAS: Country[] = [
  {
    ...
    cities: [
      ...
      { name: "Сургут", slug: "surgut", lat: 61.2540, lng: 73.3962, status: "soon" },
  ...
  },
  {
    name: "Белоруссия",
    slug: "belarus",
    cities: [{ name: "Минск", slug: "minsk", lat: 53.9006, lng: 27.5590, status: "soon" }],
  },
  {
    name: "Армения",
    slug: "armenia",
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "Кутаиси", slug: "kutaisi", lat: 42.2679, lng: 42.7180, status: "soon" },
    ],
  },
  {
    name: "Турция",
  ...
  },
  {
    ...
    slug: "colombia",
    cities: [
      { name: "Картахена", slug: "cartagena", lat: 10.3910, lng: -75.4794, status: "soon" },
